...
Verified 2026-09-05 against the current public repositories, release metadata,
...
| --- | --- | --- | --- | --- |
| [VocaLinux](https://vocalinux.com/) | Available now | Linux on X11 or Wayland; whisper.cpp, Whisper, or VOSK; current release `v0.16.2` | [Product site](https://vocalinux.com/) · [Source](https://github.com/VocaHQ/vocalinux) | AGPL-3.0 |
| [VocaMac](https://vocamac.com/) | Available now | macOS 14+ on Apple Silicon; WhisperKit / Core ML; Homebrew or DMG; current release `v1.0.0` | [Product site](https://vocamac.com/) · [Source](https://github.com/VocaHQ/vocamac) | AGPL-3.0 |
| [VocaWin](https://vocawin.com/) | Beta | Unsigned NSIS (~12 MB); latest tagged `v0.1.1-beta`. SmartScreen / unknown-publisher is expected. Testers download, try, and file issues. | [Product site](https://vocawin.com/) · [Releases](https://github.com/VocaHQ/vocawin/releases/tag/v0.1.1-beta) · [Source](https://github.com/VocaHQ/vocawin) | AGPL-3.0-or-later in the repository |
...
| [VocaGateway](https://vocagateway.vocahq.com/) | Beta | Self-host native macOS or Linux, or Docker Compose on Linux `amd64`/`arm64`; authenticated WebUI and QR pairing with VocaPhone; tagged try `v0.1.0`. No packaged installer, PyPI, or registry image. Gateway mode is not on-device. | [Product site](https://vocagateway.vocahq.com/) · [Releases](https://github.com/VocaHQ/vocagateway/releases/tag/v0.1.0) · [Source](https://github.com/VocaHQ/vocagateway) | AGPL-3.0 |
