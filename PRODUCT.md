...
| [VocaGateway](https://vocagateway.vocahq.com/) | Early | Self-host on macOS or Linux, or use Docker Compose on Linux `amd64`/`arm64`; authenticated WebUI and QR pairing | [Product site](https://vocagateway.vocahq.com/) · [Source](https://github.com/VocaHQ/vocagateway) | AGPL-3.0 |
