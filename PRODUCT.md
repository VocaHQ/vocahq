...
| [VocaWin](https://vocawin.com/) | Beta | Unsigned NSIS (~12 MB) and MSI (~34 MB); latest tagged `v0.1.1-beta`. SmartScreen / unknown-publisher is expected. Testers download, try, and file issues. | [Product site](https://vocawin.com/) · [Releases](https://github.com/VocaHQ/vocawin/releases/tag/v0.1.1-beta) · [Source](https://github.com/VocaHQ/vocawin) | AGPL-3.0-or-later in the repository |
