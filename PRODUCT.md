...
Verified 2026-08-24 against the current public repositories, release metadata,
...
| [VocaWin](https://vocawin.com/) | Beta | Unsigned NSIS (~12 MB) and MSI (~34 MB) on GitHub Releases; latest tagged `v0.1.0-alpha.3`. SmartScreen / unknown-publisher is expected. Testers download, try, and file issues. | [Product site](https://vocawin.com/) · [Releases](https://github.com/VocaHQ/vocawin/releases) · [Source](https://github.com/VocaHQ/vocawin) | AGPL-3.0-or-later in the repository |
