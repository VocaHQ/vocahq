...
| [VocaWin](https://vocawin.com/) | Beta | Unsigned NSIS (~12 MB) and MSI (~34 MB); latest tagged `v0.1.0-beta.1`. SmartScreen / unknown-publisher is expected. Testers download, try, and file issues. | [Product site](https://vocawin.com/) · [Source](https://github.com/VocaHQ/vocawin) | AGPL-3.0-or-later in the repository |
